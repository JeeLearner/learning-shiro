package com.learn.chapter16.runas.web.controller;

import com.learn.chapter16.runas.service.UserRunAsService;
...
public class RunAsController {
    ...
    public String switchTo(
        ...
        redirectAttributes.addFlashAttribute("msg", "操作成功");
        redirectAttributes.addFlashAttribute("user", switchToUser);
